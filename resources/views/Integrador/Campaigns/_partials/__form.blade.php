<div class="form-group">
    ...
    <input type="text" name="name" class="form-control" placeholder="Nome da Campanha:"
        value="{{ $campaign->name ?? '' }}">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" name="endpoint_link2b" class="form-control" placeholder="Endpoint Link2B:"
        value="{{ $campaign->endpoint_link2b ?? '' }}">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <select name="type" class="form-control">
        <option selected>{{ $campaign->type ?? 'Selecione uma Opção' }}</option>
...
<div class="form-group">
    ...
    <input type="text" name="endpoint_customer" class="form-control" placeholder="Endpoint Integração:"
        value="{{ $campaign->endpoint_customer ?? '' }}">
</div>
<div class="form-group">
